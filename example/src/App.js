  ...
  async init() {
    initContracts({
      ...
      this.result = {
        ...
        getBallotBasicCreator: (await contracts.ballotStorage.getBallotBasic(1))
          .creator,
        getBallotMemberNewMemberAddress: (
          await contracts.ballotStorage.getBallotMember(1)
        ).newMemberAddress,
        ...
        updateBallotDurationData: contracts.ballotStorage.updateBallotDuration(
          1,
          86400
        ).data,
        updateBallotMemoData: contracts.ballotStorage.updateBallotMemo(
          1,
          "0x54657374"
        ).data,
        ...
        isMember: await contracts.governance.isMember(
          "0xC03B19F95D409c26b64B44292827a26989D2E8d0"
        ),
        ...
        addProposalToChangeMemberData:
          contracts.governance.addProposalToChangeMember(
        ...
        addProposalToRemoveMemberData:
          contracts.governance.addProposalToRemoveMember(
            testProposal.addr,
            testProposal.amount,
            testProposal.textToHex
          ).data,
        lockedBalanceOf: await contracts.staking.lockedBalanceOf(
          "0xC03B19F95D409c26b64B44292827a26989D2E8d0"
        ),
        balanceOf: await contracts.staking.balanceOf(
          "0xC03B19F95D409c26b64B44292827a26989D2E8d0"
        ),
        availableBalanceOf: await contracts.staking.availableBalanceOf(
          "0xC03B19F95D409c26b64B44292827a26989D2E8d0"
        ),
